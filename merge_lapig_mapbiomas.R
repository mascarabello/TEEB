...
## 1985
lap <- raster("pa_br_pastagem_lapig_100m_1985_albers_corrigido.tif"); lap;
...
out <- writeStart(out, filename = "pa_br_usoterra_mapbiomas7_lapig_100m_1985_albers_corrigido.tif",format = 'Gtiff',overwrite=TRUE,options=c("COMPRESS=DEFLATE","ZLEVEL=9","PREDICTOR=2","TFW=YES"))
