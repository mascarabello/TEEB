...
p2 <- dt2_label %>%
  ...
  ggtitle("Área de CPD (Mha)") +
  coord_polar("y", start = 0) +
  theme_void() +
  theme(plot.title = element_text(hjust = 0.5, size = 18),
        legend.text = element_text(size = 14),  # Ajuste o tamanho da fonte
...
ggsave(filename = '/Users/marlucescarabello/Dropbox/Work/GPP/Teeb/P4_adicional/conversao_cpd_tamanhoimovel.png', plot = t,units = 'in', dpi = 300, scale = 2.0)
