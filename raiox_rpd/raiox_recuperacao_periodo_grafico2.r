...
ggsave(filename = '/Users/marlucescarabello/Dropbox/Work/GPP/Teeb/P4_adicional/recuperacao_pd_periodo_tamanhoimovel_28nov23.png', plot = t,units = 'in', dpi = 300, scale = 1.5)
