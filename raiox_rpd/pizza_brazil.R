...
dt1 <- data.frame(
  ...
  "Area" = c( 2.1,1.2,3.3,1.4,3.1),
  'Perc1' = c(19,11,29,13,28)
)
...
ggsave(filename = '/Users/marlucescarabello/Dropbox/Work/GPP/Teeb/P4_adicional/pizza_area.png', plot = p1, units = 'in', dpi = 300, scale = 1.5)
...
ggsave(filename = '/Users/marlucescarabello/Dropbox/Work/GPP/Teeb/P4_adicional/pizza_numero2.png', plot = p2, units = 'in', dpi = 300, scale = 1.5)
